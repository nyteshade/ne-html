...
`
      ...
      get(target, property, receiver) {
        ...
        if (factoryElements) {
          ...
          if (typeof factory === "function" && typeof config === "object") {
            ...
            return (...args2) => factory.call(thisArg, config, ...args2);
          }
        }
  ...
  HTML[commands.register]("script:module", function scriptSource2(config, srcOrImports, initialContent, attrs) {
    let src = void 0;
    let imports = [];
    if (srcOrImports) {
...
//# sourceMappingURL=html.bundle.2.3.0.js.map
